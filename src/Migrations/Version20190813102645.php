 ...
 */
final class Version20190813102645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job ADD user_id INT DEFAULT NULL, DROP author');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job ADD author VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP user_id');
    }
}
